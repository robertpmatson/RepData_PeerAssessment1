...
The median value of the number of steps per day is `r sprintf("%.3f", stepMedian) `

The mean value of the number of steps per day is `r sprintf("%.3f", stepMean) `
...
The Interval with the highest average number of steps is `r highestInterval`
...
The new value of the median of the number of steps per day is: `r sprintf("%.3f", stepMedian) `  
The new value of the mean of the number of steps per day is: `r sprintf("%.3f", stepMean) `
